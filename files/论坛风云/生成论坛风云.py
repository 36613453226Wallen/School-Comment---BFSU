...
EXCLUDED_PROMO = [
    ...
    ("英语学院", "研究生部", "北鼎英美文学90.6、路灯跨考、查字典美国研究", "考研机构/转载站上岸稿，不是读研日常"),
    ("高级翻译学院", "研究生部", "张旭校友访谈（复语班作业否决项）", "官网风采/出色个例，口径同尚姝辰"),
    ("俄语学院", "研究生部", "赵梦雪校友会采访", "本科在黑龙江大学；北外段是硕博出色个例"),
...
def write_excel(rows, fenyun_split):
    ...
    notes = [
        ...
        "高翻本科部不适用。续搜补了张旭复语班作业现场，但按出色个例不进合格格；英院研究生部仍无课堂日记。",
        "法语学院口译在读帖不记入高翻。",
